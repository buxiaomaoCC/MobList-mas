package com.example.myapplication.view.dropdown;
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                viewHolder.tv.setTextColor(context.getResources().getColor(R.color.gray));
                viewHolder.tv.setBackgroundResource(R.drawable.check_bg);
            } else {
                viewHolder.tv.setTextColor(context.getResources().getColor(R.color.t2));
